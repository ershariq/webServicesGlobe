        ...
        <div class="row">
            <div class="col-lg-8 m-auto">
                <div class="about-inner-header heading9 text-center">
                    <h1>Pricing Plan</h1>
                    <a href="index.php">Home <i class="fa-solid fa-angle-right"></i> <span>Pricing Plan</span></a>
                </div>
            </div>
        </div>
    </div>
          ...
          <table>
            ...
            <tbody>
              ...
              <tr class="compare-row compare-footer">
                ...
                <td><a href="pricing.php" class="header-btn1">$999/ Month<span><i class="fa-solid fa-arrow-right"></i></span></a></td>
                <td class="standard"><a href="pricing.php" class="header-btn1">$1999/ Month<span><i class="fa-solid fa-arrow-right"></i></span></a></td>
                <td><a href="pricing.php" class="header-btn1">$2999/ Month<span><i class="fa-solid fa-arrow-right"></i></span></a></td>
              </tr>
            </tbody>
          </table>
