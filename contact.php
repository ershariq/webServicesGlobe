        ...
        <div class="row">
            <div class="col-lg-8 m-auto">
                <div class="about-inner-header heading9 text-center">
                    <h1>Contact Us</h1>
                    <a href="index.php">Home <i class="fa-solid fa-angle-right"></i> <span>Contact Us</span></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="heading2 contact-header">
                   <h5>Contact Us</h5>
                   <h2>Get in Touch with WSG <br> We Value Your Connection</h2>
                   <p>Our team is here to provide quick and reliable support, making sure your needs are fully addressed. We value clear communication and are always ready to assist. Contact us through phone, email, live chat, or drop by our office during working hours.</p>
                   ...
                   <div class="number-address-area">
                    <div class="phone-number">
                        ...
                        <div class="content">
                            <p>Phone Number</p>
                            <a href="tel:+91-9083536033">+91-9083536033</a>
                        </div>
                    </div>
                    ...
                    <div class="phone-number m-0">
                        ...
                        <div class="content">
                            <p>Email Address</p>
                            <a href="mailto:Infowsg@gmail.com">Infowsg@gmail.com</a>
                        </div>
                    </div>
                   </div>
                   ...
                   <div class="number-address-area2">
                    <div class="phone-number">
                        ...
                        <div class="content">
                               Noida Sector 62 Gautam Buddha <br> Nagar Uttar Pradesh-201309
                        </div>
                    </div>

                    <div class="phone-number">
                        <a href="https://maps.app.goo.gl/wJubbfFjQa87HAoBA" class="map" target="_blank">View In Map</a>
                    </div>
                   </div>
                </div>
            </div>
