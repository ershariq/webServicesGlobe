            ...
            <div class="col-lg-6">
                <div class="works-header-area heading2">
                    ...
                    <div class="works-content-box">
                        ...
                        <div class="content">
                            <a href="case.php">Proven Result</a>
      ...
      <div class="col-lg-7">
        <div class="images-content-area">
          ...
          <div class="content-area">
            <h5>Our Value</h5>
            <a href="service1.php" class="text">Explore Our Unique Value Proposition & How We Drive Business Growth</a>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="history-box-content">
                                <h5>2015</h5>
                                <a href="service1.php">Inception and Founding</a>
                                <p>SEOC was founded with a vision to revolutionize the digital marketing industry and provide innovation.</p>
                                <a href="service1.php" class="readmore">Read More <i class="fa-solid fa-arrow-right"></i></a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="history-box-content">
                                <h5>2016</h5>
                                <a href="service1.php">Expansion and Growth</a>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="history-box-content">
                                <h5>2017</h5>
                                <a href="service1.php">Recognition and Awards</a>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="history-box-content">
                                <h5>2018</h5>
                                <a href="service1.php">Launch of New Services</a>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="history-box-content">
                                <h5>2019</h5>
                                <a href="service1.php">Strategic Partnerships </a>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="history-box-content">
                                <h5>2020</h5>
                                <a href="service1.php">Continued Growth  Success</a>
