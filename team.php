        ...
        <div class="row">
            <div class="col-lg-8 m-auto">
                <div class="about-inner-header heading9 text-center">
                    ...
                    <a href="index.php">Home <i class="fa-solid fa-angle-right"></i><span>Meet The Team</span></a>
                </div>
            </div>
        </div>
    </div>
                  ...
                  <div class="testimonial-content-slider slider-nav1">
                    <div class="testimonial-slider-boxarea">
                        ...
                        <div class="space24"></div>
                         ...
                         <div class="content">
                            <a href="team.php">Anderson Belly</a>
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6">
            <div class="team-boxarea">
              ...
              <div class="content">
                <a href="team.php">Florence Walker</a>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="team-boxarea">
              ...
              <div class="content">
                <a href="team.php">Miss Darrin Larkin</a>
                <p>Orchestrator</p>
              </div>
            </div>
            <div class="space30"></div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-5">
                <div class="works-header-area heading2 specing2">
                    ...
                    <div class="space32"></div>
                    <div class="btn-area1">
                        <a href="case.php" class="header-btn1">Our Case Study <span><i class="fa-solid fa-arrow-right"></i></span></a>
                    </div>
                </div>
            </div>
        </div>
