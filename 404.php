        ...
        <div class="row">
            <div class="col-lg-8 m-auto">
                <div class="about-inner-header heading9 text-center">
                    <h1>404 Error</h1>
                    <a href="index.php">Home <i class="fa-solid fa-angle-right"></i> <span>404 Error</span></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-6 m-auto">
                <div class="heading2 text-center">
                    ...
                    <div class="btn-area1">
                        <a href="index.php" class="header-btn1">Back To Home <span><i class="fa-solid fa-arrow-right"></i></span></a>
                    </div>
                </div>
            </div>
        </div>
