        ...
        <div class="row">
            <div class="col-lg-8 m-auto">
                <div class="about-inner-header heading9 text-center">
                    ...
                    <a href="index.php">Home <i class="fa-solid fa-angle-right"></i> Case Study <i class="fa-solid fa-angle-right"></i> <span>Social Media Marketing</span></a>
                </div>
            </div>
        </div>
    </div>
                          ...
                          <div class="row align-items-center">
                            <div class="col-lg-4">
                                <div class="case-inner-box">
                                    ...
                                    <div class="content-area">
                                      <div class="link-area">
                                          <a href="case-single.php" class="tags">#SEO</a>
                                          <a href="case-single.php" class="head">Comprehensive SEO Audit</a>
                                      </div>
                                      <div class="arrow">
                                        <a href="case-single.php"><i class="fa-solid fa-arrow-right"></i></a>
                                      </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                              <div class="case-inner-box">
                                ...
                                <div class="content-area">
                                  <div class="link-area">
                                      <a href="case-single.php" class="tags">#Web</a>
                                      <a href="case-single.php" class="head">Keyword Research & Analysis</a>
                                  </div>
                                  <div class="arrow">
                                    <a href="case-single.php"><i class="fa-solid fa-arrow-right"></i></a>
                                  </div>
                            ...
                            <div class="col-lg-4">
                              <div class="case-inner-box">
                                ...
                                <div class="content-area">
                                  <div class="link-area">
                                      <a href="case-single.php" class="tags">#PPC</a>
                                      <a href="case-single.php" class="head">One Page Optimization</a>
                                  </div>
                                  <div class="arrow">
                                    <a href="case-single.php"><i class="fa-solid fa-arrow-right"></i></a>
                                  </div>
                            ...
                            <div class="col-lg-4">
                              <div class="case-inner-box">
                                ...
                                <div class="content-area">
                                  <div class="link-area">
                                      <a href="case-single.php" class="tags">#Branding Marketing</a>
                                      <a href="case-single.php" class="head">Online Media Management</a>
                                  </div>
                                  <div class="arrow">
                                    <a href="case-single.php"><i class="fa-solid fa-arrow-right"></i></a>
                                  </div>
                              ...
                              <div class="case-inner-box">
                                ...
                                <div class="content-area">
                                  <div class="link-area">
                                      ...
                                      <a href="case-single.php" class="head">Online Management</a>
                                  </div>
                                  <div class="arrow">
                                    <a href="case-single.php"><i class="fa-solid fa-arrow-right"></i></a>
                                  </div>
                              ...
                              <div class="case-inner-box">
                                ...
                                <div class="content-area">
                                  <div class="link-area">
                                      ...
                                      <a href="case-single.php" class="head">Domain Migration</a>
                                  </div>
                                  <div class="arrow">
                                    <a href="case-single.php"><i class="fa-solid fa-arrow-right"></i></a>
                                  </div>
                              ...
                              <div class="case-inner-box">
                                ...
                                <div class="content-area">
                                  <div class="link-area">
                                      ...
                                      <a href="case-single.php" class="head">Content Marketing</a>
                                  </div>
                                  <div class="arrow">
                                    <a href="case-single.php"><i class="fa-solid fa-arrow-right"></i></a>
                                  </div>
                              ...
                              <div class="case-inner-box">
                                ...
                                <div class="content-area">
                                  <div class="link-area">
                                      ...
                                      <a href="case-single.php" class="head">Content Strategy</a>
                                  </div>
                                  <div class="arrow">
                                    <a href="case-single.php"><i class="fa-solid fa-arrow-right"></i></a>
                                  </div>
